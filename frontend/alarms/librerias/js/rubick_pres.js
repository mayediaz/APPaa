...
rubik = {
    ...
    initRightMenu: function(){
         if(!navbar_initialized){
            ...
            if($("#divcollapse").length > 0)
            {
                ele = 'div';
                style = 'style = "margin-top: 70%; margin-right: 23px;"';
            }

            $navbar.children(ele).each(function(){
                content_buff = $(this).html();
                ul_content = ul_content + content_buff;
            });

            ul_content = '<'+ele+' class="nav navbar-nav" '+style+'>' + ul_content + '</'+ele+'>';
