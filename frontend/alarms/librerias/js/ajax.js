...
function processReqChange(){
    ...
    if(req.readyState == 4){
        ...
        detalles.innerHTML = '<div align="center"><img src="../../recursos/images/load_ajax.gif"><br><span style="font-family:Verdana, Arial, Helvetica, sans-serif">JVMCompany</span></div> ';
    }
}
...
function processReqChange_2(){
    ...
    if(req_2.readyState == 4){
        ...
        //    ...en caso contrario, le diremos al usuario que los estamos cargando:
        detalles_2.innerHTML = '<div align="center"><img src="../../recursos/images/load_ajax.gif"><br><span style="font-family:Verdana, Arial, Helvetica, sans-serif">JVMCompany</span></div> ';
    }
}
