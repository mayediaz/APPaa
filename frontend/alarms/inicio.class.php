		...
		?>
            ...
            function miPerfil(code)
            {
                $.ajax({
                    ...
                    cache: false,
                    dataType: 'json',
                    data: ({grant_type:"authorization_code",client_id:'C14b8fdc411b38ea02bd0c19bd760f5517456953f2f8275bbb8afcec97e48cbda',client_secret:'9b4e59ad50f74a6bb88d83c42ff61e8e8d340212b6bf9ad184152b552ad14e72',code:code,redirect_uri:'http://aalarms.infomediaservice.com/alarms/inicio.php'}),
